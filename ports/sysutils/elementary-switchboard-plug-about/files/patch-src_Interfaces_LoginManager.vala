--- src/Interfaces/LoginManager.vala.orig	2021-08-26 21:03:58 UTC
...
+            interface = Bus.get_proxy_sync (BusType.SYSTEM, "org.freedesktop.ConsoleKit", "/org/freedesktop/ConsoleKit");
         } catch (Error e) {
